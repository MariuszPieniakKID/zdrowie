...
import type { PrzeslaneBadaniaProps, Document } from './types';
...
function PrzeslaneBadania({
  ...
  formatDate,
  setFiles
}: PrzeslaneBadaniaProps) {
  const renderAnalysisModal = (doc: Document) => {
    if (!doc || !doc.showAnalysis) return null;
    
    return (
      <div className="modern-modal-overlay" onClick={() => handleShowAnalysis(null as any)}>
        <div className="modern-modal-content" onClick={(e) => e.stopPropagation()}>
          <div className="modern-modal-header">
            ...
            <button 
              ...
              onClick={() => handleShowAnalysis(null as any)}
            >
              ×
            </button>
          </div>
